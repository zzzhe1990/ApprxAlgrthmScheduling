...
int DPFunction2(vector<int>& Ntemp)
{
	...
	{
		int sumOver=0;
		for (int j=0; j<AllTableElemets[i].elm.size(); j++)
		{
	...
	int maxSumValue = sumVec[maxSumIndex];
